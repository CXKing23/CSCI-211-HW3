...
public class ThreeWayDisjoint {
    ...
    public boolean isDisjoint(int[] A, int[] B, int[] C, int loopIterations) {
        ...
        return value; // No common value found
    }

    public static void main(String[] args) {
        // Test run parameters
        int inputArraySize1 = 100;
        int inputArraySize2 = 200;
        int timesToRun = 24;

        // Create an instance of ThreeWayDisjoint
        ThreeWayDisjoint threeWayDisjoint = new ThreeWayDisjoint();
        ...
        boolean result = threeWayDisjoint.isDisjoint(A1, B1, C1, timesToRun);
        ...
        result = threeWayDisjoint.isDisjoint(A2, B2, C2, timesToRun);
    ...
    // Utility method to generate random integer arrays
